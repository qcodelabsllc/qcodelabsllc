                ...
                <main className="mx-auto container min-h-full w-full mt-4 flex flex-col gap-y-8 pb-8">
                    ...
                    <section id="home" className="container w-full py-4">
                        <div className="flex flex-col items-center relative">
                            ...
                            <div
                                className="flex flex-row space-x-2 mt-5 mb-6 bg-primary text-on-primary py-3 px-6 rounded-full cursor-pointer border border-primary hover:bg-on-primary hover:text-primary transition duration-300"
